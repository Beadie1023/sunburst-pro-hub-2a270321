...
function OrdersPage() {
 ...
 <div>
 <div className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">30-Day Revenue</div>
 ...
 <TableCell>
 <StatusPill value={o.status} map={STATUS_STYLE} />
 </TableCell>
 <TableCell>
 <div className="flex flex-col gap-1">
 <StatusPill value={o.payment_status} map={PAYMENT_STYLE} />
